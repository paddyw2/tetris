...
rotate6_AB:
    ...
    */
    ...
    // and image x, y
    ldr r3, =l_block_orange_B
    ldr r2, =currentBlockImage
    str r3, [r2]
    ldr r3, =l_block_orange_black_B
...
rotate6_BC:
    ...
    */
    ...
    // step6. update image files
    // and image x, y
    ldr r3, =l_block_orange_C
    ldr r2, =currentBlockImage
    str r3, [r2]
    ldr r3, =l_block_orange_black_C
    ldr r2, =currentBlockImageBlack
    str r3, [r2]
    mov r3, #96
    ldr r2, =currentBlockSizeX
...
rotate6_CD:
    ...
    */
    ...
    // step6. update image files
    // and image x, y
    ldr r3, =l_block_orange_D
    ldr r2, =currentBlockImage
    str r3, [r2]
    ldr r3, =l_block_orange_black_D
    ldr r2, =currentBlockImageBlack
    str r3, [r2]
    mov r3, #64
    ldr r2, =currentBlockSizeX
